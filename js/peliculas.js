const getPeliculas = async() =>{
    ...
    const data = await fecth(`http://localhost/cinestar_sweb/peliculas/${idx}`)
    if( data.status == 200 ) {
                ...
                <div class="contenido-pelicula">
                    <div class="datos-pelicula">
                        ...
                        <div class="boton-pelicula"> 
                         ...
                         <div class="boton-pelicula"> 
                            <a href="http://www.youtube.com//v/${pelciula.Link}" target=_blank onclick="return hs.htmlExpand(this, { objectType: 'iframe' } )" >
